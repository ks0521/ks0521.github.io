...
| --- | --- | --- | --- | --- | --- |
| 2차 팀 프로젝트 | 귀차니즘 용사 | 방치형 RPG | 2025.03.03 - 2025.04.15 | 클라이언트 리드 | [TeamProject](https://github.com/ks0521/TeamProject) |
| 개인 프로젝트 | 그때 갑자기 건담이 나타났다 | TPS 로그라이크 | 2026.01.29 - 2026.02.27 | 1인 개발 | [SingleProject](https://github.com/ks0521/SingleProject) |
| 1차 팀 프로젝트 | 카미카쿠시 | 공포 | 2025.12.10 - 2025.12.26 | 클라이언트 리드 | [First-Game-Project](https://github.com/ks0521/First-Game-Project) |

---

# 2차 팀 프로젝트: 귀차니즘 용사

> 방치형 RPG 게임으로, 일반 스테이지에서 몬스터를 처치하고 보상을 획득해 플레이어의 스탯, 장비, 스킬을 강화하며 스테이지를 돌파하는 프로젝트입니다.
...
기획이나 콘텐츠 추가 과정에서 프레임워크 설계의 중요성을 깨달았습니다.

초반에 많은 시간을 투자하더라도 확장성 있고 범용적인 설계를 한다면 이후 기능 개발과 추가 과정에서 팀원들의 작업 능률을 높일 수 있었습니다.

또한 구조와 컨벤션을 만든 뒤에는 팀원들과 구체적으로 공유하는 과정이 필요하다는 점을 배웠습니다.

---

# 개인 프로젝트: 그때 갑자기 건담이 나타났다

> TPS 로그라이크 게임으로, 매 스테이지 불리한 상황에서 플레이어 조작을 통해 적을 처치하고 무작위 보상을 획득해 기체를 강화하며 최종 보스를 처치하는 프로젝트입니다.
...
결과적으로 전투, 보상 획득, 최종 전투 루프의 MVP 수준에 머무른 점이 가장 아쉬웠던 프로젝트였습니다.

가장 큰 문제는 지엽적인 UI 파트 구현에 매몰되어 실제 로직과 기능에 영향이 적은 무기 슬롯이나 HUD 구현에 많은 시간을 사용한 점이었습니다.

이 경험을 통해 1인 개발에서는 기능 우선순위와 일정 관리를 더 명확히 해야 한다는 점을 배웠습니다.

---

# 1차 팀 프로젝트: 카미카쿠시

> 마을에서 벌어지는 기이한 사건의 원인을 찾고 해결하는 공포 게임 프로젝트입니다.
...
팀장으로서 팀원들의 상황에 맞춰 유동적으로 일정을 조정하는 경험을 했습니다.

프로젝트 중 일부 팀원이 개인 사정으로 참여하지 못하는 상황이 발생했고, 기존의 큰 맵과 다수 오브젝트 중심 구조를 튜토리얼, 단서 탐색, 선택 분기, 멀티 엔딩 구조로 간소화했습니다.

이 경험을 통해 제한된 시간과 급작스러운 인원 변동 속에서도 프로젝트 완성도를 유지하기 위한 범위 조정과 우선순위 판단의 중요성을 배웠습니다.

...
| --- | --- | --- | --- | --- | --- | --- |
| [2차 팀 프로젝트](#team-project-2) | 귀차니즘 용사 | 방치형 RPG | 2025.03.03 - 2025.04.15 | 클라이언트 리드 | [TeamProject](https://github.com/ks0521/TeamProject) | [YouTube](https://youtu.be/7LdXl2Ow0QU) |
...
결과적으로 초기화 안정성, 데이터 준비 상태 보장, 콘텐츠 규칙 확장성을 확보하려는 설계였습니다.
